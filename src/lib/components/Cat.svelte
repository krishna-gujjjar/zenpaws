...
>
  <svg class="pet-svg" viewBox="0 0 64 64" shape-rendering="crispEdges">
    ...
    {#if petType === "cat"}
      ...
      >
        <rect x="46" y="46" width="6" height="4" fill={activePointColor} />
        <rect x="50" y="42" width="4" height="6" fill={activePointColor} />
        <rect x="54" y="34" width="4" height="10" fill={activePointColor} />
        <rect x="50" y="30" width="6" height="4" fill={activePointColor} />
        <rect x="48" y="32" width="4" height="4" fill={activePointColor} />
      </g>
      ...
      <rect x="22" y="38" width="20" height="12" fill={activeBellyColor} />

      <!-- Tabby Stripes on Back/Flanks -->
      {#if (pattern === "orange" || pattern === "mackerel") && state !== "overheat"}
        <rect x="18" y="40" width="4" height="2" fill={catColors.stripe} />
        <rect x="42" y="40" width="4" height="2" fill={catColors.stripe} />
        <rect x="18" y="46" width="4" height="2" fill={catColors.stripe} />
        <rect x="42" y="46" width="4" height="2" fill={catColors.stripe} />
      {/if}
      ...
      >
        <!-- Left Ear -->
        <rect x="16" y="11" width="8" height="3" fill={activePointColor} />
        <rect x="18" y="8" width="4" height="3" fill={activePointColor} />
        <rect x="19" y="6" width="2" height="2" fill={activePointColor} />
        <rect x="18" y="10" width="4" height="3" fill={catColors.earInner} />
        <!-- Right Ear -->
        <rect x="40" y="11" width="8" height="3" fill={activePointColor} />
        <rect x="42" y="8" width="4" height="3" fill={activePointColor} />
        <rect x="43" y="6" width="2" height="2" fill={activePointColor} />
        <rect x="42" y="10" width="4" height="3" fill={catColors.earInner} />
      </g>
      ...
      <g class:head-lift={state === "pet"}>
        ...
        {#if (pattern === "orange" || pattern === "mackerel") && state !== "overheat"}
          <rect x="28" y="15" width="2" height="3" fill={catColors.stripe} />
          <rect x="34" y="15" width="2" height="3" fill={catColors.stripe} />
        {/if}

        <!-- Siamese Face Point Mask -->
        {#if pattern === "siamese" && state !== "overheat"}
          <rect x="20" y="19" width="24" height="15" fill={catColors.point} />
          <rect x="18" y="21" width="28" height="11" fill={catColors.point} />
        {/if}

        <!-- White Muzzle for Mackerel matching Screenshot 8.40.02 AM -->
        ...
        <rect x="30" y="30" width="1" height="1" fill="#ffffff" opacity="0.9" />
        <rect x="31" y="31" width="1" height="1" fill="#ffffff" opacity="0.9" />
        <rect x="32" y="30" width="1" height="1" fill="#ffffff" opacity="0.9" />
        <rect x="33" y="31" width="1" height="1" fill="#ffffff" opacity="0.9" />
        <rect x="34" y="30" width="1" height="1" fill="#ffffff" opacity="0.9" />
    ...
    {:else if petType === "panda"}
      ...
      <g class:wobble={isWobbling}>
        ...
        <g class:head-lift={state === "pet"}>
          ...
          <rect x="17" y="19" width="10" height="10" fill={activePointColor} />
          <rect x="16" y="21" width="12" height="6" fill={activePointColor} />
          <rect x="37" y="19" width="10" height="10" fill={activePointColor} />
    ...
    {:else}
      ...
      <g class:wobble={isWobbling}>
        ...
        <g class="wings-group" class:wings-flap={state === "hunt"}>
          <rect x="12" y="34" width="8" height="14" fill={activePointColor} />
          <rect x="44" y="34" width="8" height="14" fill={activePointColor} />
        </g>
    ...
    {:else}
      ...
      {:else}
        ...
        <rect x="20" y="50" width="8" height="6" rx="2" fill={pawColor} />
        <rect x="36" y="50" width="8" height="6" rx="2" fill={pawColor} />
      {/if}
    {/if}
...
<style>
  ...
  /* Head Lift in Pet Mode matching Screenshot 8.41.17 AM */
  .head-lift {
